...
If Timer1.Enabled = True Then
    If hayRed Then frmStart.pausarReloj
    Timer1.Enabled = False
Else
    If hayRed Then frmStart.iniciarReloj
    Timer1.Enabled = True
...
If GetAsyncKeyState(33) = -32767 Then 'REPAG
    ...
    If dobleArena1 = 2 Then
        ...
        If Timer1.Enabled = False Then
            If hayRed Then frmStart.execEspuelas
            ...
            End If
        Else
            If hayRed Then frmStart.execArenaIzquierdo
        ...
        If dobleArena2 = 2 Then
            dobleArena2 = 0
             ...
             If Timer1.Enabled = False Then
                ...
                End If
            Else
                If hayRed Then frmStart.execArenaDerecho
